    ...
    function toggleFavorite() {
        setContact(prevContact=>{
            return{
                ...
                email: "itsmyrealname@example.com",
                isFavorite: true,
                isFavorite:!prevConatact.isFavourite// if i only write this then whats gonna happen is if click at star the star will work but my info will also gets removed
            }
        })
    }
